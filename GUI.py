...
class GUI(object):
    ...
    def __init__(self, MainWindow):
        ...
        self.scrollArea = QScrollArea(self.createTab)
        self.scrollArea.setGeometry(QtCore.QRect(140, 60, 161, 71))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        # Scroll Area Widget Contents
        self.scrollAreaWidgetContents = QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 159, 69))
        ...
        self.abilitiesDropdown.setGeometry(QtCore.QRect(140, 280, 151, 25))
        self.abilitiesDropdown.setObjectName("abilitiesDropdown")
        
        self.addCharButton = QPushButton(self.createTab)
        self.addCharButton.setGeometry(QtCore.QRect(30, 320, 98, 27))
